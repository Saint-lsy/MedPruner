...
class Hulumed_qwen2:
    def __new__(cls, model_path: str, args: Any) -> Any:
        if os.environ.get("use_vllm", "True") == "True":
            from models.HuluMed_Qwen2.HuluMed_Qwen2_vllm import HuluMed_Qwen2
        else:
...
class Qwen3VL:
    def __new__(cls, model_path: str, args: Any) -> Any:
        if os.environ.get("use_vllm", "True") == "True":
            from models.Qwen3_VL.Qwen3_VL_vllm import Qwen3VL
        else:
            from models.Qwen3_VL.Qwen3_VL_hf import Qwen3VL
