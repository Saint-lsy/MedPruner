...
base_path = "/mnt/private_yannqiyang/shengyuan/med3d/MedUniEval/output_result"
setting = "Qwen3-VL/origin"
datasets = ["Amos"]
...
for dataset in datasets:
        results_path = f"{base_path}/{setting}/{dataset}/results.json"
        output_metrics_path = f"{base_path}/{setting}/{dataset}/metrics_2.json"
